          ...
          <DetailsContent>
            ...
            <ul>
              <li>
                ...
                <ul>
                  <li>
                    CDD 방식 Vue + TypeScript 환경에서 Storybook 이용한 컴포넌트
                    개발
                  </li>
              ...
              <li>
                <strong>공통 GNB</strong> 사내에서 사용하고 외부에 제공해야하는
                B2B 서비스로 Webpack 으로 구성한 프로젝트에 GNB 마크업 운영 및
                버전관리, 업데이트 기록 후 전파
              </li>
              <li>
        ...
        <Details>
          ...
          <DetailsContent>
            ...
            <p>
              ...
              웹표준 스터디, 세미나 스탭 활동, 대회 참여, 업계 선배님들에게 많은
              가르침과 조언을 받아 웹에이전시 그래피티, 미디어포스에서
      ...
      <Section>
          ...
          <DetailsContent>
            <ul>
              <li>
                ...
                사용자가 특수한 상황에서 HTML 콘텐츠를 접했을때 이해하기 쉽도록
                부가 설명을 수록하는 등 소소한 노력을 해왔습니다.
              </li>
              <li>
              ...
              <li>
                축적된 노하우와 좋은 솔루션으로 더 빠르게 마크업할 수 있습니다.
                웹표준/웹접근성 준수는 덤입니다.
              </li>
            </ul>
          </DetailsContent>
        ...
        <Details>
          ...
          <DetailsContent>
            <ul>
              <li>
                Vue Emoji Picker 컴포넌트를 개발하면서 대용량 데이터를 처리하는
                Virtual Scroll 기법, Lazy Loading 기법을 적용하는 방법을
                공부하였습니다.
              </li>
              <li>
                툰스푼 프로젝트에 Lazy Image Loading 컴포넌트를 개발하여 상용에
                적용하여 페이지 로딩 속도에 기여하였습니다.
              </li>
              <li>
              ...
              <li>
                ...
                있으며 개발자 도구를 활용하여 문제를 해결하는 방법까지 숙지하고
                있습니다.
              </li>
            </ul>
          </DetailsContent>
        ...
        <Details>
          ...
          <DetailsContent>
            <p>
              회사에서 React를 경험해볼 수 있는 기회가 없어 토이프로젝트를 하고
              있습니다. 첫번째는 회사 업무 요구사항의 일부를 React로 구현해보는
              작업, 두번째는 Gatsby로 개인블로그를 만드는 것. 세번째는 CDD
              방식으로 회원가입 페이지를 개발하는 일입니다.
            </p>
            <ul>
              <li>
              ...
              <li>
                ...
                생성기들의 장단점을 비교하고 선택할 수 있으며 Next.js, Gatsby 의
                차이점을 이해하고 있습니다.
              </li>
              <li>
        ...
        <Details>
          ...
          <DetailsContent>
            <ul>
              <li>
                타입 정의를 하는데 많은 고민을 하는데 시간을 잡아먹었습니다. 이
                불필요한 시간을 줄이기 위해 정해둔 목표가 끝나면 가장 먼저
                타입스크립트의 기본기를 공부할 계획입니다.
              </li>
            </ul>
          </DetailsContent>
        </Details>
